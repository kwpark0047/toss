...
const v1Controller = {
    ...
    getMenus: catchAsync(async (req, res) => {
        ...
        const products = await prisma.products.findMany({
            ...
            select: { 
                id: true, name: true, price: true, description: true, image_url: true,
    ...
    ackPrintJob: catchAsync(async (req, res) => {
        ...
        if (isNaN(id)) {
            return res.status(400).json({ error: 'invalid_request', message: '올바르지 않은 프린트 잡 ID 형식입니다.' });
        }
