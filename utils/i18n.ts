...
import { t, getAlimtalkTemplate, getNotificationTemplate, translations } from './i18nTranslations.js';
 ...
 */
export const i18nMiddleware = (req: any, res: any, next: Function) => {
...
// 다국어 번역 함수 (알림톡/영수증/알림) - i18nTranslations에서 재수출
export { t, getAlimtalkTemplate, getNotificationTemplate, translations } from './i18nTranslations.js';