...
export function parseProductOptions(options: any): any[] {
  if (!options) return [];
  try {
...
function sameIdentifier(left: any, right: any): boolean {
  return (
    left !== undefined &&
    left !== null &&
    right !== undefined &&
...
export function priceOrderItem(product: any, item: any, storeId: number): {
  product_id: number;
  product_name: string;
  quantity: number;
  price: number;
...
export function assertClientTotal(clientTotal: number, serverTotal: number): void {
