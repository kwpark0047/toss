        ...
        <div className="flex-1 overflow-y-auto p-10 space-y-10">
          ...
          {activeTab === 'detail' && (
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {/* 대표 이미지 */}
              <div className="space-y-4">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] ml-1">대표 이미지</label>
                <div className="flex gap-4">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      placeholder="이미지 URL 또는 로컬 파일 업로드"
                ...
                {form.image_url && (
                  <div className="relative max-w-sm">
                    ...
                    <img src={form.image_url} alt="미리보기" className="relative w-full aspect-video object-cover rounded-[24px] border border-white/10 shadow-2xl" />
                  </div>
                )}
              </div>
