...
const PRODUCTS = [
  ...
  { id:3,  cat:'signature',  name:'블랙 세서미 라떼',        price:6800, description:'국내산 흑임자와 오트밀크의 고소하고 부드러운 조화',          image_url:'https://images.unsplash.com/photo-1577961046272-3a87cd5ccf5a?w=400&auto=format&fit=crop', isPopular:false, isNew:true,  isSoldOut:false, options:[TEMP,SIZE] },
  ...
  { id:8,  cat:'non-coffee', name:'말차 라떼',               price:5500, description:'교토산 최상급 말차와 우유의 깊고 진한 맛',                    image_url:'https://images.unsplash.com/photo-1515823662972-da6a2ab5cfd0?w=400&auto=format&fit=crop', isPopular:true,  isNew:false, isSoldOut:false, options:[TEMP,SIZE] },
  { id:9,  cat:'non-coffee', name:'초코 라떼',               price:5500, description:'벨기에산 다크초콜릿과 우유의 달콤한 조화',                    image_url:'https://images.unsplash.com/photo-1548254853-b985b3fa0fb5?w=400&auto=format&fit=crop', isPopular:false, isNew:false, isSoldOut:false, options:[TEMP,SIZE] },
  { id:10, cat:'non-coffee', name:'얼 그레이 밀크티',        price:5500, description:'고급 얼그레이 잎을 우려낸 진한 밀크티',                       image_url:'https://images.unsplash.com/photo-1593502560432-dcf2cb5e8fd4?w=400&auto=format&fit=crop', isPopular:false, isNew:true,  isSoldOut:false, options:[TEMP] },
  ...
  { id:14, cat:'dessert',    name:'크렘 브륄레 타르트',     price:6500, description:'바삭한 타르트 위에 부드러운 커스터드 크림',                     image_url:'https://images.unsplash.com/photo-1519915028121-7d3463d5b1ff?w=400&auto=format&fit=crop', isPopular:true,  isNew:false, isSoldOut:false, options:[] },
  ...
  { id:17, cat:'food',       name:'크로아상 샌드위치',       price:7000, description:'버터향 가득한 크로아상에 에그 마요와 베이컨',                   image_url:'https://images.unsplash.com/photo-1509722747041-616f39b57ef3?w=400&auto=format&fit=crop', isPopular:true,  isNew:false, isSoldOut:false, options:[] },
