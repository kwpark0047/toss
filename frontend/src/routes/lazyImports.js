...
export const NotificationTemplatesManager = lazy(() => import("./components/admin/NotificationTemplatesManager"));
...
export const FoodTruckOwnerDashboard = lazy(() => import("./components/admin/FoodTruckOwnerDashboard"));
export const FoodTruckAnalyticsDashboard = lazy(() => import("./components/admin/FoodTruckAnalyticsDashboard"));
export const MultiStoreSupervisorDashboard = lazy(() => import("./components/admin/MultiStoreSupervisorDashboard"));
export const AlimtalkDeliveryConsole = lazy(() => import("./components/admin/AlimtalkDeliveryConsole"));
