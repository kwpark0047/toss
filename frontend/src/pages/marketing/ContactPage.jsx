...
export default function ContactPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    phone: '',
    email: '',
    category: 'GENERAL', // GENERAL, PAY_CONTRACT, FOOD_TRUCK, PARTNERSHIP
    message: ''
  });
  ...
  const navItems = [
    ...
    { label: '문의하기', to: '/contact', active: true }
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans">
            ...
            {navItems.map(item => (
              <Link 
                ...
                className={`text-sm font-bold tracking-tight transition-all ${
                  item.active ? 'text-orange-500' : 'text-slate-100'
                }`}
              >
                {item.label}
              </Link>
      ...
      {/* 컨택트 레이아웃 */}
      <section className="relative py-20 lg:py-28 overflow-hidden max-w-7xl mx-auto px-6">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_-20%,rgba(249,115,22,0.1),transparent_50%)] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <h2 className="text-3xl lg:text-4xl font-black tracking-tight mb-4">
                비즈니스에 맞는<br />
                <span className="bg-gradient-to-r from-orange-400 to-rose-500 bg-clip-text text-transparent">상담 및 도입 문의</span>
              </h2>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 bg-slate-900/30 border border-slate-900 p-4 rounded-2xl max-w-sm">
                ...
                <div>
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">이메일 지원</p>
                  <p className="text-xs font-mono font-bold text-slate-200">support@wemarket.co.kr</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-slate-900/30 border border-slate-900 p-4 rounded-2xl max-w-sm">
                ...
                <div>
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">고객 센터</p>
                  <p className="text-xs font-mono font-bold text-slate-200">1544-3024 (평일 09:00 - 18:00)</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-slate-900/30 border border-slate-900 p-4 rounded-2xl max-w-sm">
                ...
                <div>
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">본사 위치</p>
                  <p className="text-xs font-bold text-slate-200 leading-snug">서울특별시 강남구 테헤란로 152 (역삼동, 파이낸스센터)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* 우측 인쇄 접수 양식 */}
          <div className="lg:col-span-7 bg-slate-900/40 border border-slate-900 rounded-3xl p-8 lg:p-10 shadow-2xl relative">
            <AnimatePresence mode="wait">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input 
                        ...
                        placeholder="홍길동"
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-xs focus:outline-none focus:border-orange-500 transition-all placeholder-slate-600"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        onChange={handleInputChange}
                        placeholder="ceo@wemarket.co.kr"
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-xs focus:outline-none focus:border-orange-500 transition-all placeholder-slate-600"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      onChange={handleInputChange}
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-xs focus:outline-none focus:border-orange-500 text-slate-300 transition-all"
                    >
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      onChange={handleInputChange}
                      placeholder="매장 규모, 테이블 개수, 현재 운영 중이신 업종 정보 등을 기입해 주시면 더욱 정확하고 빠른 상담을 받으실 수 있습니다."
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-xs focus:outline-none focus:border-orange-500 transition-all placeholder-slate-600 resize-none leading-relaxed"
                    />
                  </div>
                ...
                <div className="py-20 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <h3 className="text-xl font-black text-slate-100 mb-3">상담 신청 접수 완료!</h3>
                  ...
                  <button 
                    ...
                    className="px-6 py-2.5 bg-slate-950 hover:bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 text-xs font-bold rounded-xl transition-all"
                  >
                    새로운 문의 작성하기
                  </button>
                </div>
