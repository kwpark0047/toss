  ...
  return <div className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <section className="pb-24 max-w-5xl mx-auto px-6">
        <div className="space-y-6">
          {steps.map((step, idx) => <div key={idx} className="bg-slate-50 border border-slate-200 hover:border-slate-300 rounded-2xl p-6 md:p-8 flex items-start gap-6 transition-all">
      ...
      <section className="pb-24 max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-3">
          {faqs.map((faq, idx) => <div key={idx} className="bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden">
              ...
              {openFaq === idx && <div className="px-6 pb-4">
