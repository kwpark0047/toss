...
const AppRoutes = memo(() => <Routes>
    ...
    <Route path="/admin/stores/:storeId/recommendation-stats" element={<AdminPage><ValidStoreRoute><AdminSuspense><RecommendationStatsPage /></AdminSuspense></ValidStoreRoute></AdminPage>} />
    ...
    <Route path="/admin/stores/:storeId/foodtruck/design" element={<AdminPage><ValidStoreRoute><AdminSuspense><FoodTruckDesignShowcase /></AdminSuspense></ValidStoreRoute></AdminPage>} />
