...
const createOrderSchema = z.object({
  ...
  items: z
    ...
    .min(1, '주문 항목은 최소 1개 필요합니다.')
    .max(100),
  paymentMethod: z
    .enum(['cash', 'card', 'transfer', 'kakao_pay', 'naver_pay', 'toss_pay', 'point', 'mixed'])
    .default('card'),
  paymentDetails: z
    .object({
...
// 고객 웹 푸시 토큰 등록 경로(:orderId) 전용 파라미터
const customerTokenParamSchema = z.object({
