...
router.get('/store/:storeId/recommendations',
  authMiddleware,
...
router.post('/store/:storeId/recommendations',
  authMiddleware,
...
router.get('/store/:storeId/recommendations/:id',
  authMiddleware,
  checkStorePermission('stats:read'),
  aiRecommendationsController.getRecommendationById
);

router.patch('/store/:storeId/recommendations/:id',
  authMiddleware,
  checkStorePermission('products:write'),
  aiRecommendationsController.updateRecommendation
);

router.delete('/store/:storeId/recommendations/:id',
  authMiddleware,
  checkStorePermission('products:write'),
  aiRecommendationsController.deleteRecommendation
);

router.get('/store/:storeId/segments',
  authMiddleware,
  checkStorePermission('stats:read'),
  aiRecommendationsController.getCustomerSegments
);

router.post('/store/:storeId/segments',
  authMiddleware,
  checkStorePermission('products:write'),
